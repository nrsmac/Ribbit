...
import com.nrsmac.ribbit.com.nrsmac.ribbit.adapters.SectionsPagerAdapter;
...
public class MainActivity extends FragmentActivity implements
                    ...
                    switch (which) {
                        ...
                        case 1: //Take Video
                            ...
                            if (mMediaUri == null) {
                                ...
                                videoIntent.putExtra(MediaStore.EXTRA_SIZE_LIMIT, 0);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            ...
            else if (requestCode == CHOOSE_VIDEO_REQUEST || requestCode == TAKE_PHOTO_REQUEST) {
