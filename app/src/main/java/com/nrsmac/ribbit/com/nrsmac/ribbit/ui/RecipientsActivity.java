...
import com.nrsmac.ribbit.com.nrsmac.ribbit.com.nrsmac.ribbit.utils.FileHelper;
...
//        mProgressBar.setVisibility(View.VISIBLE);
    ...
    protected ArrayList<String> getRecipientIds() {
        ArrayList<String> recipientLds = new ArrayList<String>();
        for (int i = 0; i < mGridView.getCount(); i++) {
            if (mGridView.isItemChecked(i)) {
                recipientLds.add(mFriends.get(i).getObjectId());
            }
        }
        return recipientLds;
    }
        ...
        message.saveInBackground(new SaveCallback() {
            ...
            public void done(ParseException e) {
                if (e == null) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(RecipientsActivity.this);
                    builder.setMessage(getString(R.string.error_sending_message_message))
                            .setTitle(getString(R.string.error_sending_message_title))
                            .setPositiveButton(android.R.string.ok, null);
                    AlertDialog dialog = builder.create();
                    dialog.show();
                }
